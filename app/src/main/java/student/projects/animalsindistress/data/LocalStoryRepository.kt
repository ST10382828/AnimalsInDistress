...
class LocalStoryRepository(private val context: Context) : StoryRepository {
    ...
    /**
     * Public method to load all stories - used by Gallery and other fragments.
     * Marked as public to avoid reflection hacks.
     */
    fun loadAllStories(): List<Story> {
        ...
        return try {
            ...
            Log.e(TAG, "Failed to load stories from JSON", e)
            emptyList()
        }
    }

    /**
     * Clear cache to force reload. Useful for refresh functionality.
     */
    fun clearCache() {
        cachedStories = null
    }
    ...
    companion object {
        private const val TAG = "LocalStoryRepository"
    }
}
