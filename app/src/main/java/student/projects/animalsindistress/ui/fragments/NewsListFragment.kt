...
class NewsListFragment : Fragment(R.layout.fragment_news_list) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerView.adapter = NewsAdapter(newsArticles) { articleId ->
            // Navigate to news detail with slug argument
            val action = NewsListFragmentDirections.actionNewsListFragmentToNewsDetailFragment(articleId)
...
class NewsAdapter(
    ...
    class NewsViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        val titleText: TextView = view.findViewById(R.id.news_item_title)
        val dateText: TextView = view.findViewById(R.id.news_item_date)
        val excerptText: TextView = view.findViewById(R.id.news_item_excerpt)
        val readMoreLayout: View = view.findViewById(R.id.news_item_read_more)
        val card: CardView = view.findViewById(R.id.news_item_card)
    }
    ...
    override fun onBindViewHolder(holder: NewsViewHolder, position: Int) {
        ...
        holder.excerptText.text = article.excerpt
        holder.card.setOnClickListener { onArticleClick(article.id) }
        holder.readMoreLayout.setOnClickListener { onArticleClick(article.id) }
    }
